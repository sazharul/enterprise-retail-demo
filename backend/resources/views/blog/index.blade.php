        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('blog.create') }}" class="btn btn-success btn-sm" title="Add New Post">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New Post
                        </a>

                        <form method="GET" action="{{ route('blog.index') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search"
                                ...
                                @foreach($blog as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('blog.edit',$item->id) }}" title="Edit Blog">
                                                <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit
                                                </button>
                                            </a>

                                            <form method="POST" action="{{ route('blog.destroy', $item->id) }}" accept-charset="UTF-8"
