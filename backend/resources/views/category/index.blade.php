            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('category.index') }}" accept-charset="UTF-8"
                                    ...
                                    @foreach ($category as $item)
                                        <tr>
                                            ...
                                            <td><img src="{{ asset($item->image) }}" alt="" width="150px"
                                                    height="100px"></td>
                                            <td><img src="{{ asset($item->icon) }}" alt="" width="150px"
                                                    height="100px"></td>
                                            <td>{{ $item->status == 1 ? 'Active' : 'InActive' }}</td>
                                            <td>{{ $item->parent_id == 0 ? 'Root' : $item->parent->name }}</td>
                                            <td>
