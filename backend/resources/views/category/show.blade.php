            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('category.index') }}" title="Back">
                            <button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</button>
                        </a>
                        <a href="{{ route('category.edit',$category->id) }}" title="Edit Brand">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        <th> Image</th>
                                        <td> <img src="{{ $category->image }}" alt="" width="100px" height="150px"> </td>
                                    </tr>
                                    <tr>
                                        <th> Status</th>
