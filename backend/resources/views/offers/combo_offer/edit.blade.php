...
@section('content')
    <div class="main-content">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Assign Combo Products (Edit)</div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('combo_offer.update', $offer->id) }}" method="POST">
                            @csrf
                                                ...
                                                @if (count($comboProducts) > 0)
                                                    @foreach ($comboProducts as $comboProduct)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="checkbox" class="checkbox" name="combo_product_id[]" value="{{ $comboProduct->id }}" @if ($comboOffers->contains($comboProduct->id)) checked @endif>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                @endif
