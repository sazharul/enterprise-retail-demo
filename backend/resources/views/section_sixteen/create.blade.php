@extends('layouts.app')
@section('title', 'Section 16 CreateOrEdit')
@section('content')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('section_sixteen.index') }}" title="Back"><button class="btn btn-warning btn-sm"><i
                        ...
                        <form id="section_sixteen" action="{{ route('section_sixteen.index') }}" class="row g-3" novalidate
                            ...
                            <div class="col-md-4 col-sm-4">
                                ...
                                <select class="form-select" id="offer_id" name="offer_id"
                                    onchange="updateproduct(this,'{{ route('section_sixteen.create') }}')">
...
@push('scripts')
    <script src="{{ asset('backend/assets/js/section16.js') }}"></script>
    <script>
        $(document).ready(function() {
            ...
            updateproduct(this, '{{ route('section_sixteen.create') }}');
