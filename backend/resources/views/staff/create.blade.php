    ...
    <div class="main-content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!--begin::Form-->
                <form class="validate-form" action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Card Body-->
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" required class="form-control" id="name" placeholder="Staff Name" value="{{old('name')}}">
                                </div>
                                <div class="form-group">
                                    <label for="email" class="col-form-label">Email Address</label>
                                    <input type="email" name="email" required class="form-control" id="email" placeholder="Email Address" value="{{old('email')}}">
                                </div>
                                
                                <div class="form-group">
                                    <label for="name" class="col-form-label">Mobile Number</label>
                                    <input type="text" name="phone" required class="form-control" id="phone" placeholder="Mobile Number" value="{{old('name')}}">
                                </div>
