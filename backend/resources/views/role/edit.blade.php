    ...
    <div class="main-content">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <!--begin::Form-->
                <form class="validate-form" action="{{ route('role.update', $role->id) }}" method="POST">
                    @csrf
                    <!--begin::Card Body-->
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" required class="form-control" id="role_name" placeholder="Role Name" value="{{ $role->name }}">
                                    </div>
                                </div>
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="checkPermissionAll" value="1" {{ roleHasPermissions($role, $permissions) ? 'checked' : '' }}>
...
<script>
    ...
    function implementAllChecked() {
        ...
        console.log('countPermissions', countPermissions);
        console.log('countPermissionGroups', countPermissionGroups);
        console.log('total', countPermissions + countPermissionGroups);
