        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('color.create') }}" class="btn btn-success btn-sm" title="Add New Brand">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ route('color.index') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search"
                                ...
                                @foreach($color as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('color.edit',$item->id ) }}" title="Edit Brand">
                                                <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit
                                                </button>
                                            </a>

                                            <form method="POST" action="{{ route('color.destroy',$item->id) }}" accept-charset="UTF-8"
