...
jQuery(document).ready(function(){
  ...
  // Check if the element with ID 'numbering' exists
  var numberingElement = document.getElementById('numbering');
  var getnumber = numberingElement ? parseInt(numberingElement.innerHTML) : 0;
  ...
  jQuery("#loadMore").on("click", function(e){
    ...
    getnumber = getnumber + 6;

    // Check if 'numberingElement' is not null before updating the HTML
    if (numberingElement) {
      numberingElement.innerHTML = getnumber;
    }
