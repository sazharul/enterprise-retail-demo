...
const DropDownMenuItemSlug = ({items, title, isSearch = true, setSelectedItems}) => {
    ...
    useEffect(() => {
        ...
        setSelectedCheckboxes(selectedCheckboxValues);
                                        ...
                                        <div className="max-h-[308px] overflow-hidden overflow-y-auto sidebar-scroll-control">
                                            {FilteredBrandList.map((Brand, i) => (
                                                <label
                                                    ...
                                                    onChange={() => handleCheckboxChange(Brand.slug, title)}
                                                >
                                                    <div className="relative flex items-center">
                                                        <input type="checkbox"
                                                               className={`rounded h-4 w-4 ${selectedCheckboxes.includes(Brand.slug) ? "bg-[#5DC9F4] text-white" : "bg-white"} border border-[#0094CF] appearance-none`}/>
...
export default DropDownMenuItemSlug;
